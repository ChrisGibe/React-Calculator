    ...
    if (["+", "-", "*", "/", "=", "C"].indexOf(value) !== -1) {
      ...
      if (this.currentDisplayValue === 0 || this.currentOperation == null) {
        ...
        switch (this.currentOperation) {
          case "+":
            this.currentDisplayValue = Utils.addition(Number(this.currentDisplayValue), Number(this.lastDisplayValue));

            break;
          case "-":
            this.currentDisplayValue = Utils.substraction(Number(this.lastDisplayValue), Number(this.currentDisplayValue));

            break;
          case "*":
            this.currentDisplayValue = Utils.multiplication(Number(this.currentDisplayValue), Number(this.lastDisplayValue));

            break;
          case "/":
            this.currentDisplayValue = Utils.division(Number(this.lastDisplayValue), Number(this.currentDisplayValue));
